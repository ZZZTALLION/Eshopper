...
<head>
    ...
    <meta name="Sánchez Zaldivar " content="">
		...
		<div class="header-middle"><!--header-middle-->
			<div class="container">
				<div class="row">
					...
					<H3>SOFTWARE PUNTO DE VENTAS</H3>
					<div class="col-sm-8">
						Por: Teresa Zaldivar
						<!--Las tres líneas anteriores son solo para agregar información a la página principal-->
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">

								<li><a href="agregarproductos.php"><i class="fa fa-plus"></i> Agregar</a></li>
		...
		<div class="container">
			<div class="row">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								<div class="panel panel-default">
									...
									<h4 class="panel-title"><a href="#">EXTRAS </a></h4>
									<!--Las tres líneas anteriores te permiten agregar categorías de ropa-->
								</div>
							</div>
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items--> <!--Las siguientes líneas de código hasta llegar a la 220 nos permite mostrar los productos que tenemos para ponerlos en el catálogo mediante un ciclo-->
...
?>
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
										...
										?>.jpg" Whith="210" height="180" alt=""/>
											<h2><?php echo $BDProductos[$n+2]; ?>
											</h2>
					...
					?>
						<!--Las 4 líneas anteriores cierran el ciclo.-->
					</div><!--features_items-->
					...
					<div class="recommended_items"><!--recommended_items-->
						...
						<!--Las siguientes líneas nos permiten añadir productos a la sección de productos recomendados-->
